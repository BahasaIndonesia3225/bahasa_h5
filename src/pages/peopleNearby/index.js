...
import { List, Form, Input, Modal, Toast, Button, FloatingPanel, Space, SearchBar, Avatar, Card } from 'antd-mobile';
import { HandPayCircleOutline, GiftOutline, SoundOutline, VideoOutline, MailOutline, GlobalOutline } from 'antd-mobile-icons';
import Map from './map'
